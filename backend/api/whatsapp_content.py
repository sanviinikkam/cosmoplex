...
ONBOARD = {
    "en": {
        ...
        "free_offer": "🎁 {name}, a special deal *only for you* — sign up now and your *entire course is FREE*… but only if you claim it right now. 👇",
    ...
    "hi": {
        ...
        "free_offer": "🎁 {name}, *सिर्फ़ आपके लिए* खास ऑफ़र — अभी साइन अप करें और आपका *पूरा कोर्स मुफ़्त*… पर सिर्फ़ तभी जब आप इसे अभी ले लें। 👇",
    ...
    "mr": {
        ...
        "free_offer": "🎁 {name}, *फक्त तुमच्यासाठी* खास ऑफर — आत्ताच साइन अप करा आणि तुमचा *संपूर्ण कोर्स मोफत*… पण फक्त तुम्ही तो आत्ताच घेतलात तरच. 👇",
    ...
    "te": {
        ...
        "free_offer": "🎁 {name}, *మీ కోసం మాత్రమే* ప్రత్యేక ఆఫర్ — ఇప్పుడే సైన్ అప్ చేయండి, మీ *పూర్తి కోర్సు ఉచితం*… కానీ మీరు ఇప్పుడే తీసుకుంటేనే. 👇",
    ...
    "ta": {
        ...
        "free_offer": "🎁 {name}, *உங்களுக்கு மட்டும்* ஒரு சிறப்பு சலுகை — இப்போதே பதிவு செய்யுங்கள், உங்கள் *முழு பாடநெறியும் இலவசம்*… ஆனால் இப்போதே பெற்றால் மட்டுமே. 👇",
    ...
    "kn": {
        ...
        "free_offer": "🎁 {name}, *ನಿಮಗಾಗಿ ಮಾತ್ರ* ವಿಶೇಷ ಕೊಡುಗೆ — ಈಗಲೇ ಸೈನ್ ಅಪ್ ಮಾಡಿ, ನಿಮ್ಮ *ಸಂಪೂರ್ಣ ಕೋರ್ಸ್ ಉಚಿತ*… ಆದರೆ ನೀವು ಈಗಲೇ ಪಡೆದರೆ ಮಾತ್ರ. 👇",
