...
CONTENT = {
    "en": {
        ...
        "menu_btn": "🌐 Language",
        "answer_btn": "Answer",
        "quiz_progress": "📝 Quiz · Question {n}/{t}",
        ...
        "restart_confirm": "{name}, start the whole course again from lesson 1? Your progress so far will be cleared.",
        "restart_yes": "🔄 Yes, restart",
        "restart_no": "↩️ No, carry on",
    },
    "hi": {
        ...
        "restart_confirm": "{name}, पूरा कोर्स पाठ 1 से फिर शुरू करें? अब तक की प्रगति मिट जाएगी।",
        "restart_yes": "🔄 हाँ, फिर से",
        "restart_no": "↩️ नहीं, जारी रखें",
    ...
    "mr": {
        ...
        "quiz_progress": "📝 क्विझ · प्रश्न {n}/{t}",
        ...
        "restart_confirm": "{name}, संपूर्ण कोर्स धडा 1 पासून पुन्हा सुरू करायचा? आतापर्यंतची प्रगती जाईल.",
        "restart_yes": "🔄 हो, पुन्हा",
        "restart_no": "↩️ नाही, सुरू ठेवा",
    ...
    "te": {
        ...
        "menu_btn": "🌐 భాష",
        "answer_btn": "సమాధానం",
        "quiz_progress": "📝 క్విజ్ · ప్రశ్న {n}/{t}",
        ...
        "restart_confirm": "{name}, మొత్తం కోర్సు పాఠం 1 నుంచి మళ్లీ మొదలుపెట్టాలా? ఇప్పటివరకటి ప్రోగ్రెస్ పోతుంది.",
        "restart_yes": "🔄 అవును",
        "restart_no": "↩️ లేదు, కొనసాగించు",
    ...
    "ta": {
        ...
        "menu_btn": "🌐 மொழி",
        "answer_btn": "பதில்",
        "quiz_progress": "📝 வினாடி வினா · கேள்வி {n}/{t}",
        ...
        "restart_confirm": "{name}, முழு பாடநெறியையும் பாடம் 1-லிருந்து மீண்டும் தொடங்கவா? இதுவரையான முன்னேற்றம் அழியும்.",
        "restart_yes": "🔄 ஆம், மீண்டும்",
        "restart_no": "↩️ இல்லை, தொடரு",
    ...
    "kn": {
        ...
        "menu_btn": "🌐 ಭಾಷೆ",
        "answer_btn": "ಉತ್ತರ",
        "quiz_progress": "📝 ಕ್ವಿಜ್ · ಪ್ರಶ್ನೆ {n}/{t}",
        ...
        "restart_confirm": "{name}, ಇಡೀ ಕೋರ್ಸ್ ಪಾಠ 1 ರಿಂದ ಮತ್ತೆ ಶುರು ಮಾಡಬೇಕೆ? ಇಲ್ಲಿಯವರೆಗಿನ ಪ್ರಗತಿ ಹೋಗುತ್ತದೆ.",
        "restart_yes": "🔄 ಹೌದು",
        "restart_no": "↩️ ಇಲ್ಲ, ಮುಂದುವರಿಸಿ",
...
ONBOARD = {
    "en": {
        ...
        "name_q": "Great choice! 😊 Just type your first name.",
    ...
    "hi": {
        ...
        "name_q": "बढ़िया! 😊 अपना पहला नाम लिखें।",
    ...
    "mr": {
        ...
        "name_q": "छान! 😊 तुमचं पहिलं नाव लिहा.",
    ...
    "te": {
        ...
        "name_q": "బాగుంది! 😊 మీ మొదటి పేరు టైప్ చేయండి.",
    ...
    "ta": {
        ...
        "name_q": "நல்லது! 😊 உங்கள் முதல் பெயரை எழுதுங்கள்.",
    ...
    "kn": {
        ...
        "name_q": "ಚೆನ್ನಾಗಿದೆ! 😊 ನಿಮ್ಮ ಮೊದಲ ಹೆಸರು ಟೈಪ್ ಮಾಡಿ.",
