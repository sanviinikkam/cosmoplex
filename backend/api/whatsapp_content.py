...
CONTENT = {
    "en": {
        ...
        "ai_daily_limit": "🙋 {name}, that's all the questions I can answer today ({n}). They come back tomorrow.\n\nThe lessons and quizzes carry on as normal — tap below to keep going. 👇",
        ...
        "problem_ask": "😕 Sorry about that, {name}. What exactly went wrong? Tell me what you tapped and what happened.\n\n🎤 *A voice note is fine too.*",
        "problem_thanks": "🛠️ Thanks {name} — that's logged and the team will look at it. Let's carry on in the meantime.",
        "cert_caption": "Cosmoplex AI Literacy — Level {level} Certificate 🎓",
        "cert_level_ready": "🎓 Congratulations {name} — you've earned your *Level {level} certificate*! Here it is 👇",
        "levels_news": "📣 {name}, we've reshaped the course into *levels*.\n\n🎓 *Level 1* is the first 3 modules — {m1}, {m2} and {m3} microlessons, *{total} in all*. Finish them and your *Level 1 certificate* arrives right here as a PDF.\n\nYou're *{done} of {total}* lessons in. Keep going 👇",
    ...
    "hi": {
        ...
        "ai_daily_limit": "🙋 {name}, आज के लिए इतने ही सवाल ({n}) — कल फिर से पूछ सकते हैं।\n\nLessons और quiz हमेशा की तरह चालू हैं — आगे बढ़ने के लिए नीचे tap करें। 👇",
        ...
        "cert_caption": "Cosmoplex AI Literacy — Level {level} Certificate 🎓",
        "cert_level_ready": "🎓 बधाई हो {name} — आपने अपना *Level {level} certificate* हासिल कर लिया! ये रहा 👇",
        "levels_news": "📣 {name}, हमने कोर्स को *levels* में बदल दिया है।\n\n🎓 *Level 1* पहले 3 modules हैं — {m1}, {m2} और {m3} microlessons, *कुल {total}*। इन्हें पूरा कीजिए और आपका *Level 1 certificate* यहीं PDF में आ जाएगा।\n\nआप *{total} में से {done}* पाठ कर चुके हैं। आगे बढ़ते रहिए 👇",
        ...
        "problem_ask": "😕 माफ़ कीजिए {name}। ठीक-ठीक क्या दिक्कत आई? बताइए आपने क्या tap किया और क्या हुआ।\n\n🎤 *Voice note भी भेज सकते हैं।*",
        "problem_thanks": "🛠️ धन्यवाद {name} — यह note कर लिया गया है, team इसे देखेगी। तब तक हम आगे बढ़ते हैं।",
    },
    "mr": {
        ...
        "ai_daily_limit": "🙋 {name}, आजसाठी एवढेच प्रश्न ({n}) — उद्या पुन्हा विचारू शकता.\n\nLessons आणि quiz नेहमीप्रमाणे सुरू आहेत — पुढे जाण्यासाठी खाली tap करा. 👇",
        ...
        "cert_caption": "Cosmoplex AI Literacy — Level {level} Certificate 🎓",
        "cert_level_ready": "🎓 अभिनंदन {name} — तुम्ही तुमचं *Level {level} certificate* मिळवलंत! हे घ्या 👇",
        "levels_news": "📣 {name}, आम्ही कोर्स *levels* मध्ये बदलला आहे.\n\n🎓 *Level 1* म्हणजे पहिले 3 modules — {m1}, {m2} आणि {m3} microlessons, *एकूण {total}*. ते पूर्ण करा आणि तुमचं *Level 1 certificate* इथेच PDF मध्ये येईल.\n\nतुम्ही *{total} पैकी {done}* धडे पूर्ण केले आहेत. पुढे चालू ठेवा 👇",
        ...
        "problem_ask": "😕 माफ करा {name}. नेमकं काय बिघडलं? तुम्ही काय tap केलं आणि काय झालं ते सांगा.\n\n🎤 *Voice note पण चालेल.*",
        "problem_thanks": "🛠️ धन्यवाद {name} — हे नोंदवलं आहे, team बघेल. तोपर्यंत आपण पुढे जाऊया.",
    },
    "te": {
        ...
        "ai_daily_limit": "🙋 {name}, ఈరోజుకి ఇన్ని ప్రశ్నలే ({n}) — రేపు మళ్లీ అడగవచ్చు.\n\nLessons, quiz యథావిధిగా నడుస్తాయి — కొనసాగడానికి కింద tap చేయండి. 👇",
        ...
        "cert_caption": "Cosmoplex AI Literacy — Level {level} Certificate 🎓",
        "cert_level_ready": "🎓 అభినందనలు {name} — మీరు మీ *Level {level} certificate* సాధించారు! ఇదిగోండి 👇",
        "levels_news": "📣 {name}, మేము కోర్సును *levels* గా మార్చాము.\n\n🎓 *Level 1* అంటే మొదటి 3 modules — {m1}, {m2} మరియు {m3} microlessons, *మొత్తం {total}*. వాటిని పూర్తి చేస్తే మీ *Level 1 certificate* ఇక్కడే PDF గా వస్తుంది.\n\nమీరు *{total} లో {done}* పాఠాలు పూర్తి చేశారు. కొనసాగించండి 👇",
        ...
        "problem_ask": "😕 క్షమించండి {name}. సరిగ్గా ఏమి తప్పు జరిగింది? మీరు దేనిపై tap చేశారు, ఏమి జరిగిందో చెప్పండి.\n\n🎤 *Voice note కూడా పంపవచ్చు.*",
        "problem_thanks": "🛠️ ధన్యవాదాలు {name} — ఇది నమోదైంది, team చూస్తుంది. అప్పటివరకు కొనసాగుదాం.",
    },
    "ta": {
        ...
        "ai_daily_limit": "🙋 {name}, இன்றைக்கு இத்தனை கேள்விகள் தான் ({n}) — நாளை மீண்டும் கேட்கலாம்.\n\nLessons மற்றும் quiz வழக்கம் போல் தொடரும் — தொடர கீழே tap செய்யுங்கள். 👇",
        ...
        "cert_caption": "Cosmoplex AI Literacy — Level {level} Certificate 🎓",
        "cert_level_ready": "🎓 வாழ்த்துக்கள் {name} — உங்கள் *Level {level} certificate* பெற்றுவிட்டீர்கள்! இதோ 👇",
        "levels_news": "📣 {name}, நாங்கள் பாடநெறியை *levels* ஆக மாற்றியுள்ளோம்.\n\n🎓 *Level 1* என்பது முதல் 3 modules — {m1}, {m2} மற்றும் {m3} microlessons, *மொத்தம் {total}*. அவற்றை முடித்தால் உங்கள் *Level 1 certificate* இங்கேயே PDF ஆக வரும்.\n\nநீங்கள் *{total} இல் {done}* பாடங்கள் முடித்துள்ளீர்கள். தொடருங்கள் 👇",
        ...
        "problem_ask": "😕 மன்னிக்கவும் {name}. சரியாக என்ன தவறு நடந்தது? நீங்கள் எதை tap செய்தீர்கள், என்ன நடந்தது என்று சொல்லுங்கள்.\n\n🎤 *Voice note அனுப்பினாலும் சரி.*",
        "problem_thanks": "🛠️ நன்றி {name} — இது பதிவாகிவிட்டது, team பார்க்கும். அதுவரை தொடர்வோம்.",
    },
    "kn": {
        ...
        "ai_daily_limit": "🙋 {name}, ಇಂದಿಗೆ ಇಷ್ಟೇ ಪ್ರಶ್ನೆಗಳು ({n}) — ನಾಳೆ ಮತ್ತೆ ಕೇಳಬಹುದು.\n\nLessons ಮತ್ತು quiz ಎಂದಿನಂತೆ ನಡೆಯುತ್ತವೆ — ಮುಂದುವರಿಯಲು ಕೆಳಗೆ tap ಮಾಡಿ. 👇",
        ...
        "cert_caption": "Cosmoplex AI Literacy — Level {level} Certificate 🎓",
        "cert_level_ready": "🎓 ಅಭಿನಂದನೆಗಳು {name} — ನೀವು ನಿಮ್ಮ *Level {level} certificate* ಗಳಿಸಿದ್ದೀರಿ! ಇಲ್ಲಿದೆ 👇",
        "levels_news": "📣 {name}, ನಾವು ಕೋರ್ಸ್ ಅನ್ನು *levels* ಆಗಿ ಬದಲಾಯಿಸಿದ್ದೇವೆ.\n\n🎓 *Level 1* ಎಂದರೆ ಮೊದಲ 3 modules — {m1}, {m2} ಮತ್ತು {m3} microlessons, *ಒಟ್ಟು {total}*. ಅವುಗಳನ್ನು ಮುಗಿಸಿದರೆ ನಿಮ್ಮ *Level 1 certificate* ಇಲ್ಲೇ PDF ಆಗಿ ಬರುತ್ತದೆ.\n\nನೀವು *{total} ರಲ್ಲಿ {done}* ಪಾಠಗಳನ್ನು ಮುಗಿಸಿದ್ದೀರಿ. ಮುಂದುವರಿಸಿ 👇",
        ...
        "problem_ask": "😕 ಕ್ಷಮಿಸಿ {name}. ನಿಖರವಾಗಿ ಏನು ತಪ್ಪಾಯಿತು? ನೀವು ಯಾವುದನ್ನು tap ಮಾಡಿದಿರಿ ಮತ್ತು ಏನಾಯಿತು ಎಂದು ತಿಳಿಸಿ.\n\n🎤 *Voice note ಕೂಡ ಕಳಿಸಬಹುದು.*",
        "problem_thanks": "🛠️ ಧನ್ಯವಾದ {name} — ಇದು ದಾಖಲಾಗಿದೆ, team ನೋಡುತ್ತದೆ. ಅಲ್ಲಿಯವರೆಗೆ ಮುಂದುವರಿಯೋಣ.",
    },
}
