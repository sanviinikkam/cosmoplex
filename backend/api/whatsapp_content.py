...
CONTENT = {
    "en": {
        ...
        "next_prompt": "Ready for the next lesson, {name}? 👇",
    ...
    "hi": {
        ...
        "next_prompt": "{name}, अगला पाठ शुरू करें? 👇",
        "next_btn": "▶️ अगला पाठ",
    ...
    "mr": {
        ...
        "next_prompt": "{name}, पुढचा धडा सुरू करूया? 👇",
        "next_btn": "▶️ पुढचा धडा",
    ...
    "te": {
        ...
        "next_prompt": "{name}, తదుపరి పాఠం మొదలుపెడదామా? 👇",
    ...
    "ta": {
        ...
        "next_prompt": "{name}, அடுத்த பாடத்தைத் தொடங்கலாமா? 👇",
    ...
    "kn": {
        ...
        "next_prompt": "{name}, ಮುಂದಿನ ಪಾಠ ಶುರುಮಾಡೋಣವೇ? 👇",
...
ONBOARD = {
    "en": {
        ...
        "free_offer": "🎁 {name}, a *limited-time* offer, only for you — sign up right now and get our *₹499 course absolutely FREE*. Grab it before it's gone. 👇",
    ...
    "hi": {
        ...
        "free_offer": "🎁 {name}, *सीमित समय* का ऑफ़र, सिर्फ़ आपके लिए — अभी साइन अप करें और पाएँ *₹499 का कोर्स बिल्कुल मुफ़्त*। खत्म होने से पहले ले लें। 👇",
    ...
    "mr": {
        ...
        "free_offer": "🎁 {name}, *मर्यादित काळाची* ऑफर, फक्त तुमच्यासाठी — आत्ताच साइन अप करा आणि मिळवा *₹499 चा कोर्स अगदी मोफत*. संपण्याआधी घ्या. 👇",
    ...
    "te": {
        ...
        "free_offer": "🎁 {name}, *పరిమిత సమయం* ఆఫర్, మీ కోసం మాత్రమే — ఇప్పుడే సైన్ అప్ చేయండి, *₹499 విలువైన కోర్సు పూర్తిగా ఉచితంగా* పొందండి. అయిపోకముందే తీసుకోండి. 👇",
    ...
    "ta": {
        ...
        "free_offer": "🎁 {name}, *வரம்பிட்ட கால* சலுகை, உங்களுக்கு மட்டும் — இப்போதே பதிவு செய்யுங்கள், *₹499 மதிப்புள்ள பாடநெறியை முற்றிலும் இலவசமாக* பெறுங்கள். தீரும் முன் பெறுங்கள். 👇",
    ...
    "kn": {
        ...
        "free_offer": "🎁 {name}, *ಸೀಮಿತ ಅವಧಿಯ* ಕೊಡುಗೆ, ನಿಮಗಾಗಿ ಮಾತ್ರ — ಈಗಲೇ ಸೈನ್ ಅಪ್ ಮಾಡಿ, *₹499 ಮೌಲ್ಯದ ಕೋರ್ಸ್ ಸಂಪೂರ್ಣ ಉಚಿತವಾಗಿ* ಪಡೆಯಿರಿ. ಮುಗಿಯುವ ಮೊದಲು ಪಡೆಯಿರಿ. 👇",
