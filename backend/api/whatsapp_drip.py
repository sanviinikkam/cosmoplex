...
NUDGE_TEXT = {
    ...
    "start_lesson": {
        "en": [
            "{name}, your first lesson is just sitting here waiting 🎬 2 minutes and you'll know what AI actually is — no jargon 💬 shall we?",
            "{name}, lesson one is still unopened 🎬 everyone starts at zero — two minutes and you won't be there any more. Shall we? 🚀",
        ],
        "hi": [
            "{name}, आपका पहला पाठ यहीं बैठा इंतज़ार कर रहा है 🎬 2 मिनट और आप जान जाएँगे AI असल में क्या है — बिना भारी शब्दों के 💬 चलें?",
            "{name}, पहला पाठ अब तक खुला ही नहीं 🎬 शुरुआत सब शून्य से करते हैं — दो मिनट और आप वहाँ नहीं रहोगे। शुरू करें? 🚀",
        ],
        "mr": [
            "{name}, तुमचा पहिला धडा इथेच वाट बघत बसलाय 🎬 2 मिनिटांत कळेल AI म्हणजे नक्की काय — अवघड शब्दांशिवाय 💬 सुरू करूया?",
            "{name}, पहिला धडा अजून उघडलाच नाही 🎬 सुरुवात सगळेच शून्यापासून करतात — दोन मिनिटं आणि तुम्ही तिथे नसाल. सुरू करूया? 🚀",
        ],
        "te": [
            "{name}, మీ మొదటి పాఠం ఇక్కడే వేచి ఉంది 🎬 2 నిమిషాల్లో AI అసలు ఏమిటో తెలుస్తుంది — క్లిష్ట పదాలు లేకుండా 💬 మొదలుపెడదామా?",
            "{name}, మొదటి పాఠం ఇంకా తెరవనే లేదు 🎬 అందరూ సున్నా నుంచే మొదలు — రెండు నిమిషాలు, మీరు అక్కడ ఉండరు. మొదలుపెడదామా? 🚀",
        ],
        "ta": [
            "{name}, உங்க முதல் பாடம் இங்கயே காத்திருக்கு 🎬 2 நிமிஷத்துல AI உண்மையில் என்னன்னு தெரியும் — கடின வார்த்தைகள் இல்லாம 💬 ஆரம்பிக்கலாமா?",
        ...
        "kn": [
            "{name}, ನಿಮ್ಮ ಮೊದಲ ಪಾಠ ಇಲ್ಲೇ ಕಾಯ್ತಾ ಇದೆ 🎬 2 ನಿಮಿಷದಲ್ಲಿ AI ನಿಜವಾಗಿ ಏನು ಅಂತ ಗೊತ್ತಾಗುತ್ತೆ — ಕಠಿಣ ಪದಗಳಿಲ್ಲದೆ 💬 ಶುರು ಮಾಡೋಣವೇ?",
    ...
    "keep_learning": {
        "en": [
            "{name}, you're all caught up 😎 more lessons coming soon — got AI questions? my DMs are always open 🌟",
            "{name}, still here 👋 new lessons are on the way — in the meantime, ask me anything about what you learned 🌟",
        ],
        "hi": [
            "{name}, आप पूरी तरह अप-टु-डेट हैं 😎 और पाठ जल्द आ रहे हैं — AI का कोई सवाल हो तो DM खुला है 🌟",
            "{name}, अब भी यहीं हूँ 👋 नए पाठ रास्ते में हैं — तब तक, जो सीखा उस पर मुझसे कुछ भी पूछिए 🌟",
        ],
        "mr": [
            "{name}, तुम्ही पूर्ण अप-टु-डेट आहात 😎 अजून धडे येतायत — AI बद्दल काही प्रश्न? DM नेहमी खुला आहे 🌟",
            "{name}, अजूनही इथेच आहे 👋 नवे धडे येतायत — तोपर्यंत, जे शिकलात त्याबद्दल मला काहीही विचारा 🌟",
        ],
        "te": [
            "{name}, మీరు పూర్తిగా అప్-టు-డేట్ 😎 ఇంకా పాఠాలు వస్తున్నాయి — AI గురించి ఏదైనా సందేహమా? DM ఎప్పుడూ తెరిచే ఉంది 🌟",
            "{name}, ఇంకా ఇక్కడే ఉన్నాను 👋 కొత్త పాఠాలు వస్తున్నాయి — అప్పటిదాకా, నేర్చుకున్నదాని గురించి ఏదైనా అడగండి 🌟",
        ],
        "ta": [
            "{name}, நீங்க முழுசா அப்-டு-டேட் 😎 இன்னும் பாடங்க வரும் — AI பத்தி ஏதாவது சந்தேகமா? DM எப்பவும் ஓபன் 🌟",
            "{name}, இன்னும் இங்கதான் இருக்கேன் 👋 புதுப் பாடங்கள் வந்துட்டு இருக்கு — அதுவரை, கத்துக்கிட்டதைப் பத்தி எதுவும் கேளுங்க 🌟",
        ],
        "kn": [
            "{name}, ನೀವು ಸಂಪೂರ್ಣ ಅಪ್-ಟು-ಡೇಟ್ 😎 ಇನ್ನೂ ಪಾಠಗಳು ಬರುತ್ತಿವೆ — AI ಬಗ್ಗೆ ಏನಾದರೂ ಪ್ರಶ್ನೆ? DM ಯಾವಾಗಲೂ ತೆರೆದಿದೆ 🌟",
